...
namespace lab7
{
    class Program
    {
        ...
        static List<Staff> s = new List<Staff>()
            {
                new Staff(1, "Kotsionova", 12),
                new Staff(2, "Zhelankina", 14),
                new Staff(3, "Fedorova", 12),
                new Staff(4, "Nurlyeva", 11),
                new Staff(5, "Alexxxevna", 13),

            };

        static List<Department> d = new List<Department>()
            {
                new Department(11, "music"),
                new Department(12, "coding"),
                new Department(13, "sleep"),
                new Department(14, "dance"),
